...
class EzvizCamera
{
    ...
    {
        log::add('jeezviz', 'debug', "Initialize the camera object.\r\n");
        $this->_serial = $serial;
        $this->_client = $client;
    ...
    function load()
    {
        log::add('jeezviz', 'debug', "Load object properties\r\n");
    ...
    function status()
    {
        log::add('jeezviz', 'debug', "Return the status of the camera.\r\n");
    ...
    {
        log::add('jeezviz', 'debug', "Moves the camera to the ".$direction."\r\n");
        $allowedDirections=array('right','left','down','up');
        if (!in_array($direction, $allowedDirections))
        {
            log::add('jeezviz', 'debug', "Invalid direction: ".$direction."\r\n");
            return false;
        }
    ...
    {
        log::add('jeezviz', 'debug', "Enable/Disable camera sound when movement is detected.\r\n");
    ...
    {
        log::add('jeezviz', 'debug', "Switch audio status on a device.\r\n");
